...
/**
 * Class ArrayKeyExistsViewHelper
 *
 ...
 *
 * Example:
 *   {vh:ArrayKeyExists(needle: value, haystack: selectedValues)}  // returns boolean
 *
 ...
 */
class ArrayKeyExistsViewHelper extends AbstractViewHelper
{
    /**
    ...
    public function initializeArguments(): void
    {
        ...
        $this->registerArgument(
            'needle',
            'mixed',
            'The key to search for (strict comparison by default).',
            true
        );
